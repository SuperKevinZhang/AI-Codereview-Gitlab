...
[Options]
DINGTALK_WEBHOOK_URL_{YOUR_PROJECT_NAME}={YOUR_WDINGTALK_WEBHOOK_URL}
DINGTALK_SECRET={YOUR_DINGTALK_SECRET}
[Options]
DINGTALK_SECRET_{YOUR_PROJECT_NAME}={YOUR_DINGTALK_SECRET}

#飞书消息推送: 0不发送飞书消息,1发送飞书消息
FEISHU_ENABLED=0
FEISHU_WEBHOOK_URL={YOUR_FEISHU_WEBHOOK_URL}
[Options]
FEISHU_WEBHOOK_URL_{YOUR_PROJECT_NAME}={YOUR_FEISHU_WEBHOOK_URL}
FEISHU_SECRET={YOUR_FEISHU_SECRET}
[Options]
FEISHU_SECRET_{YOUR_PROJECT_NAME}={YOUR_FEISHU_SECRET}
